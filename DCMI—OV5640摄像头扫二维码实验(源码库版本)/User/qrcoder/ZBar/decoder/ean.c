...
static const unsigned char *dsprintbuf(ean_decoder_t *ean)
{
    int i;
    for(i = 0; i < 7; i++)
...
static int check_width (unsigned w0,
                               unsigned w1)
{
    unsigned dw0 = w0;
    w0 *= 8;
 ...
 */
static signed char aux_mid (zbar_decoder_t *dcode)
{
...
static char ean_part_end2 (ean_decoder_t *ean,
                                  ean_pass_t *pass)
{
...
static char ean_part_end5 (ean_decoder_t *ean,
                                  ean_pass_t *pass)
{
...
static zbar_symbol_type_t integrate_partial (ean_decoder_t *ean,
                                                    ean_pass_t *pass,
