 ...
 */
static unsigned decode_sort3 (zbar_decoder_t *dcode,
                                     int i0)
{
 ...
 */
static unsigned decode_sortn (zbar_decoder_t *dcode,
                                     int n,
                                     int i0)
{
...
static char acquire_lock (zbar_decoder_t *dcode,
...
static char release_lock (zbar_decoder_t *dcode,
                                 zbar_symbol_type_t req)
{
